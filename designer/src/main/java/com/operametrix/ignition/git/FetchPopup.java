...
/**
 * Lightweight popup for selecting which remote to fetch from.
...
public class FetchPopup extends JDialog {
    ...
    private JPanel buildUI() {
        ...
        fetchBtn.addActionListener(e -> {
            ...
            onFetch(selectedRemote != null ? selectedRemote : "origin");
            dispose();
        });
     ...
     * Override in an anonymous subclass to handle the fetch operation.
     */
